#Gráficas de ocupación por sexo ingreso por hora, mayores de 14 menores de 75 años
...
ENOEB<-ENOEB[ENOEB$ING_X_HRS >0,]#ojo
sum(ENOEB[ENOEB$SEX=="HOMBRE",]$FAC)
sum(ENOEB[ENOEB$SEX=="MUJER",]$FAC)
table(ENOEB$SEX)

###Ninguna
Ninguna <- ggplot(ENOEB[ENOEB$CS_P13_1=="Ninguna",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
Ninguna <- Ninguna + geom_smooth(aes(weight = FAC))
Ninguna <- Ninguna + xlab("Edad (14 a 75 años)") +ylab("Ingreso por hora") + ggtitle("Ingreso por hora, Escolaridad (Ninguna) y Sexo(ENOE, IV 2015) ")
Ninguna
ggsave("graphs/Ing_sexo_ninguna.png", plot = Ninguna, dpi = 500, width = 14, height = 11)

###
Primaria <- ggplot(ENOEB[ENOEB$CS_P13_1=="Primaria",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
###
Secundaria <- ggplot(ENOEB[ENOEB$CS_P13_1=="Secundaria",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
###
Tecnica <- ggplot(ENOEB[ENOEB$CS_P13_1=="Carrera técnica",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
####
Preparatoria <- ggplot(ENOEB[ENOEB$CS_P13_1=="Preparatoria o bach",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
#####
Profesional <- ggplot(ENOEB[ENOEB$CS_P13_1=="Profesional",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
Maestria <- ggplot(ENOEB[ENOEB$CS_P13_1=="Maestría",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
...
Doctorado <- ggplot(ENOEB[ENOEB$CS_P13_1=="Doctorado",], aes(EDA, ING_X_HRS, color = SEX)) #edad, Ingreso mensual, sexo, para personas con preescolar
